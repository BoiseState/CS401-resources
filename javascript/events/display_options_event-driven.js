 ...
 */
function display_option1_windowalert()
{
	var x = 5;
	var y = 10;
 ...
 */
function display_option2_documentGetElementById()
{
	var x = 5;
	var y = 10;
 ...
 */
function display_option3_documentwrite()
{
	var x = 5;
	var y = 10;
 ...
 */
function display_option4_consolelog()
{
	var x = 5;
	var y = 10;
