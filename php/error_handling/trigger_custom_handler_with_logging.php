...
<html>
<head>
<title>PHP Example: Error Handling: Trigger a Custom Handler With Logging</title>
...
/**
	...
	it prints the error, exports it to the log file, and emails the admin.
*/
function custom_error_function($error_number, $error_message)
{
	echo "<span class=\"error\"><b>Error</b> [$error_number]: $error_message <br>";
	echo "Watch out! This event has been logged and the administrator has been notified... </span>";
  	error_log("Error [$error_number]: $error_message\n\n", 3, "/var/log/httpd/my-errors.log");
	error_log("Error [$error_number]: $error_message", 1, "joecool@example.com");
}
